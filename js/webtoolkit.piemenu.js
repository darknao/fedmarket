	...
	initMenu : function (menuId) {
		...
		for(var i=0; i<images.length; i++) {
			...
			if (document.all && document.getElementById && !window.opera) {
				images[i].style.filter = 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="img/icon-bg.png", sizingMethod="crop")';
			} else {
				images[i].style.background = "url(img/icon-bg.png)";
			}
		}
